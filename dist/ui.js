...
export function toggleTheme() {
    ...
    savePreferencesToLocalStorage(currentTheme);
}
...
export function initializeThemeToggle() {
    ...
    if (elements.themeToggleBtnDesktop) {
        elements.themeToggleBtnDesktop.addEventListener("click", toggleTheme);
    }
...
export function handleSearch(event) {
    ...
    const searchInput = event.target.id === 'search-input-mobile'
...
export function showEntryDetailModal(entry) {
  ...
  `;
    ...
    const closeBtn = detailModal.querySelector(".close-detail-modal-btn");
    if (closeBtn) {
        closeBtn.addEventListener("click", () => {
    ...
    // Edit button handler
    const editBtn = detailModal.querySelector(".edit-entry-from-detail-btn");
    if (editBtn) {
    ...
    const deleteBtn = detailModal.querySelector(".delete-entry-from-detail-btn");
    if (deleteBtn) {
...
export function hideEntryDetailModal() {
...
function updateThemeIcons() {
    ...
    if (elements.themeToggleBtnDesktop) {
        elements.themeToggleBtnDesktop.innerHTML = icon;
    }
    if (elements.themeToggleBtnMobile) {
        elements.themeToggleBtnMobile.innerHTML = icon;
    }
}
